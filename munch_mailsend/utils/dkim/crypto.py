...
from .asn1 import SEQUENCE
from .asn1 import asn1_build
from .asn1 import asn1_parse
from .asn1 import BIT_STRING
from .asn1 import OCTET_STRING
from .asn1 import ASN1FormatError
...
HASH_ALGORITHMS = {'rsa-sha1': hashlib.sha1, 'rsa-sha256': hashlib.sha256}
...
def parse_public_key(data):
    ...
    try:
        ...
        raise UnparsableKeyError('Unparsable public key: {}'.format(e))
    return {'modulus': pkd[0][0], 'publicExponent': pkd[0][1]}
...
def parse_private_key(data):
    ...
    try:
        ...
        raise UnparsableKeyError('Unparsable private key: {}'.format(e))
    return {
        'version': pka[0][0],
        'modulus': pka[0][1],
